...
public class MemberSuccess {
	...
	public String toString() {
		String s = "";
		if(ftp!=null)s+=ftp.getNotNull();
		if(core!=null)s+=core.getNotNull();		
		return (s.length()==0)?Str.empty:s;
	} 
	
	public String getHelps(String key2) {
		switch(key2){
		case Str.ftp:return Ftp.getHelps();
		case Str.core:return Core.getHelps();
		case Str.all:return Core.getHelps()+"\n"+Ftp.getHelps()+"\n"+Help.getOthersHelps();
		}
		return "";
	} 
